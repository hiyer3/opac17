...
app.get("/fetchData", async function (req, res) {
  const doc = new GoogleSpreadsheet(
    "1ieri3VWnbTmCjxh9Tvy5e5iwzpQqK6aTGwGWoQa2YkU",
    serviceAccountAuth
  );

  await doc.loadInfo(); // loads document properties and worksheets

  const sheeId = req.query.sheetid ? req.query.sheetid : 1;

  const sheet = doc.sheetsByIndex[sheeId]; // or use `doc.sheetsById[id]` or `doc.sheetsByTitle[title]`
